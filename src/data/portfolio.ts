...
export const siteConfig = {
	...
	tagline:
		"I build scalable, efficient, and user-friendly web applications with a focus on clean backend architecture.",
	aboutHeading:
		"Turning complex requirements into clean, reliable backend systems",
	yearsExperience: "5+",
	brandTag: "<JCO />",
	footerTagline:
		"Building scalable, efficient web applications with PHP and modern backend technologies.",
...
export const projects: Project[] = [
	{
		...
		links: [
			{ label: "Customer App", url: "https://service-system-isex.vercel.app/" },
			{
				...
				url: "https://service-system-merchant.vercel.app/",
			},
		],
	},
	{
